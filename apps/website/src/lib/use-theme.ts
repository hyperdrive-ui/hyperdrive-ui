import type { AccentColor, ColorPalette, GrayColor, Radius } from '@hyperdrive-ui/panda-preset'
import { createVariables } from '@hyperdrive-ui/panda-preset/utils'
...
const loadColorPalette = async (color: string): Promise<ColorPalette> => {
  const palettes: Record<string, () => Promise<{ default: ColorPalette }>> = {
    amber: () => import('@hyperdrive-ui/panda-preset/colors/amber'),
    blue: () => import('@hyperdrive-ui/panda-preset/colors/blue'),
    bronze: () => import('@hyperdrive-ui/panda-preset/colors/bronze'),
    brown: () => import('@hyperdrive-ui/panda-preset/colors/brown'),
    crimson: () => import('@hyperdrive-ui/panda-preset/colors/crimson'),
    cyan: () => import('@hyperdrive-ui/panda-preset/colors/cyan'),
    gold: () => import('@hyperdrive-ui/panda-preset/colors/gold'),
    grass: () => import('@hyperdrive-ui/panda-preset/colors/grass'),
    green: () => import('@hyperdrive-ui/panda-preset/colors/green'),
    indigo: () => import('@hyperdrive-ui/panda-preset/colors/indigo'),
    iris: () => import('@hyperdrive-ui/panda-preset/colors/iris'),
    jade: () => import('@hyperdrive-ui/panda-preset/colors/jade'),
    lime: () => import('@hyperdrive-ui/panda-preset/colors/lime'),
    mauve: () => import('@hyperdrive-ui/panda-preset/colors/mauve'),
    mint: () => import('@hyperdrive-ui/panda-preset/colors/mint'),
    neutral: () => import('@hyperdrive-ui/panda-preset/colors/neutral'),
    olive: () => import('@hyperdrive-ui/panda-preset/colors/olive'),
    orange: () => import('@hyperdrive-ui/panda-preset/colors/orange'),
    pink: () => import('@hyperdrive-ui/panda-preset/colors/pink'),
    plum: () => import('@hyperdrive-ui/panda-preset/colors/plum'),
    purple: () => import('@hyperdrive-ui/panda-preset/colors/purple'),
    red: () => import('@hyperdrive-ui/panda-preset/colors/red'),
    ruby: () => import('@hyperdrive-ui/panda-preset/colors/ruby'),
    sage: () => import('@hyperdrive-ui/panda-preset/colors/sage'),
    sand: () => import('@hyperdrive-ui/panda-preset/colors/sand'),
    sky: () => import('@hyperdrive-ui/panda-preset/colors/sky'),
    slate: () => import('@hyperdrive-ui/panda-preset/colors/slate'),
    teal: () => import('@hyperdrive-ui/panda-preset/colors/teal'),
    tomato: () => import('@hyperdrive-ui/panda-preset/colors/tomato'),
    violet: () => import('@hyperdrive-ui/panda-preset/colors/violet'),
    yellow: () => import('@hyperdrive-ui/panda-preset/colors/yellow'),
  }
...
const syncAccentColor = async (color: AccentColor) => {
  ...
  const styleStyle = document.querySelector<HTMLStyleElement>('#hyperdrive-ui-accent')
...
const syncGrayColor = async (color: GrayColor) => {
  ...
  const styleStyle = document.querySelector<HTMLStyleElement>('#hyperdrive-ui-gray')
  if (!styleStyle) return
